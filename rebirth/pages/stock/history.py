...
def build_stock_history_figure(
    ...
    *,
    ...
    """Plot one identity and retain gaps for missing business dates."""
...
def build_stock_history_table(
    ...
    *,
    ...
    """Build exact raw historical rows for one Stock identity."""
    ...
    records = display.astype(object).where(pd.notna(display), None).to_dict("records")
