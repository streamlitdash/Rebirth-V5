        ...
        [
            ...
            html.Header(
                [
                    html.Div(
                        [
                            html.P("Rebirth V4 history", className="data-page-eyebrow"),
                            html.H1("Data", className="static-data-page-title"),
                            html.P(
                                "Choose an archived identity here, or arrive with an "
                                "exact Quick Risk or Quick Market selection.",
                ...
                [
                    ...
                    html.Div(
                        [
                            ...
                            html.Button(
                                "Unlock selection",
                                id="data-unlock-identity-button",
                                n_clicks=0,
                                disabled=True,
                                className="data-player-button",
                            ),
