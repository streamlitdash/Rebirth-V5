...
from rebirth.domain.pnl import PL_HISTORY_COLUMNS

from .common import DISPLAY_COLUMNS
        ...
        [
            html.Div(
                [
                    ...
                    html.Div(
                        html.Div(
                            "Open the History workspace to load its expandable hierarchy.",
                    ...
                    html.Div(
                        "Open the History workspace to load its validated hierarchy.",
                    ...
                    html.Details(
                        [
                            ...
                            html.P(
                                "Open this section to query up to 500 exact source rows "
                                "for the chart's hierarchy, P&L type, filters, and date "
                                "range.",
                                className="pl-editor-guide",
                            ),
                            dcc.Loading(
                                dash_table.DataTable(
                                    id="pl-history-raw-table",
                                    columns=[
                            ...
                            html.Div(
                                ...
                                id="pl-history-raw-status",
                                className="pl-send-status",
                                role="status",
                            ),
                        ],
                        id="pl-history-raw-details",
                        open=False,
                        className="aux-details",
                    ),
