...
from rebirth.ui.components import build_aggregate_pl_table, build_cube_loader
from rebirth.ui.constants import DEFAULT_VIEW_DIMENSION, VIEW_DIMENSION_FIELDS
...
from .send_view import build_pl_send_sections
...
def build_pl_page(
    *,
    ...
    if send_workflow_available:
        all_sections = build_pl_send_sections()
        current_sections = all_sections[:-1]
        history_workspace = all_sections[-1]
    else:
        current_sections = [
            html.P(
                ...
                dcc.Tabs(
                    ...
                    children=[
                        ...
                        dcc.Tab(
                            label="History",
                            value="history",
                            disabled=not send_workflow_available,
                        ),
                    ],
