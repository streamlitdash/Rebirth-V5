"""V4 Risk-only immutable Filter View defaults.

The V4 demo retains the legacy fixture labels (Macro/Credit/Hedge) without
...
_FAKE_PREFIX: Final = "fake_replace_me - "
...
def _activity_key(value: object) -> str:
    ...
    if normalized.startswith(_FAKE_PREFIX):
        normalized = normalized[len(_FAKE_PREFIX) :]
    return normalized
