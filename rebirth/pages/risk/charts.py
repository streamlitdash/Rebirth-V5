"""V4 Risk-page tenor state, line, heatmap, matrix, and detail-panel builders."""
...
from rebirth.ui.constants import METRIC_BREAKDOWNS, PLOT_METRICS, ROW_KEY_COLUMNS
...
from .explorer_tables import build_small_table
from .workspace_tables import build_new_trade_detail_table
