...
def build_custom_risk_pivot_workspace() -> html.Div:
    ...
    return html.Div(
        [
            ...
            html.Details(
                [
                    html.Summary("Pivot fields", className="risk-pivot-drawer-summary"),
                    html.Div(
                        [
                            html.Div(
                                [
                                    html.Label("Rows", htmlFor="risk-pivot-rows"),
                                    dcc.Dropdown(
                                        id="risk-pivot-rows",
                            ...
                            html.Div(
                                [
                                    html.Label("Columns", htmlFor="risk-pivot-columns"),
                                    dcc.Dropdown(
                            ...
                            html.Div(
                                [
                                    html.Label("Values", htmlFor="risk-pivot-measures"),
                                    dcc.Dropdown(
                            ...
                            html.Div(
                                [
                                    html.Label(
                                        "Filter", htmlFor="risk-pivot-filter-field"
                                    ),
                                    dcc.Dropdown(
                            ...
                            html.Div(
                                [
                                    html.Label("Sort", htmlFor="risk-pivot-sort-field"),
                                    dcc.Dropdown(
                                        id="risk-pivot-sort-field",
                                        options=_options(
                                            (*RISK_VIEW_DIMENSIONS, *RISK_VIEW_MEASURES)
                                        ),
                                        value=None,
                            ...
                            html.Div(
                                [
                                    html.Label("Presets", htmlFor="risk-pivot-preset"),
                                    dcc.Dropdown(
                                        id="risk-pivot-preset",
                                        options=[
                                            {"label": "Cross", "value": "cross"},
                                            {"label": "SplitVA", "value": "splitva"},
                                        ],
                                        value="cross",
                                        clearable=False,
                                    ),
            ...
            html.Div(
                [
                    html.Label("Row page", htmlFor="risk-pivot-row-page"),
                    dcc.Input(
                    ...
                    html.Label("Column page", htmlFor="risk-pivot-column-page"),
                    dcc.Input(
