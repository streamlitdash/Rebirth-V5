...
# uncomment their REAL registration in ``rebirth.services.sources`` and comment the
...
# from .common import MarketSource, RiskSource, exact_frame, market_frame, run_async
#
# # -------------------------------------------LIBRARIES--------------------------------------------#
#
# # generics
...
from .common import MarketSource, RiskSource, exact_frame, market_frame
...
def build_ir_adapters(
    *,
    ...
    ``rebirth.services.sources``. The refresh framework calls each market function once
