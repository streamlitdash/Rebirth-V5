...
# switch the matching registration in ``rebirth.services.sources`` from CSV to REAL.
...
# import pandas as pd
#
# from rebirth.domain.products import LIVE, OFFICIAL
#
# T = TypeVar("T")
#
...
# Keep this section active while ``rebirth.services.sources`` uses its CSV fallback.
