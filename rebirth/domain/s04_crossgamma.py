...
if TYPE_CHECKING:
    from rebirth.domain.s02_products import ProductSpec


# These are the canonical public labels owned by ``rebirth.domain.s02_products``.
...
def _product_by_pair() -> dict[tuple[str, str], ProductSpec]:
    ...
    from rebirth.domain.s02_products import PRODUCT_SPECS
