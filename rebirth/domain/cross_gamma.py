...
if TYPE_CHECKING:
    from rebirth.domain.products import ProductSpec


# These are the canonical public labels owned by ``rebirth.domain.products``.
...
def _product_by_pair() -> dict[tuple[str, str], ProductSpec]:
    ...
    from rebirth.domain.products import PRODUCT_SPECS
