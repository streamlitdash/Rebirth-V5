...
from rebirth.domain.schema import TENOR_OPTION, TENOR_ORDER_COLUMNS, TENOR_SWAP
...
def get_risk(
    ...
    # APP DATA ACCESS IS CENTRALIZED IN rebirth.services.sources.get_risk.
...
def get_market_open(
    ...
    *,
    ...
    # APP DATA ACCESS IS CENTRALIZED IN rebirth.services.sources.get_market_open.
    # Direct-library integration shape (comments only, never fallback data):
...
def get_market_status(
    ...
    *,
    ...
    # APP DATA ACCESS IS CENTRALIZED IN rebirth.services.sources.get_market_status.
    # Direct-library integration shape (comments only, never fallback data):
