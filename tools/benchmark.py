"""Measure Rebirth V4 startup and lazy-history paths on checked-in scale data."""
...
from rebirth.domain.schema import (  # noqa: E402
    PORTFOLIO_COLUMN,
    PORTFOLIO_METADATA_COLUMNS,
)
from rebirth.domain.risk_views import PivotSpec  # noqa: E402
from rebirth.domain.stock import STOCK_IDENTITY_COLUMNS  # noqa: E402
...
from rebirth.services.sources import build_production_refresh_manager  # noqa: E402
from rebirth.pages.stock.history import SQLStockHistoryRepository  # noqa: E402
from rebirth.pages.risk.explorer_tables import build_risk_table  # noqa: E402
from rebirth.pages.risk.filter_defaults import (  # noqa: E402
    default_risk_filter_payload,
)
from rebirth.pages.risk.pivot import compute_native_pivot  # noqa: E402
from rebirth.ui.aggregation import (  # noqa: E402
    apply_filters,
    default_open_rows,
    prepare_risk_data,
)
