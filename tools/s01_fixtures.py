...
from core.s07_stock import (  # noqa: E402 - support execution from any directory
    STOCK_COLUMNS,
...
def _build_history_risk(
    ...
    *,
    ...
    frame["Activity"] = [
        _fake(f"Trading Desk {value % 24 + 1:02d}") for value in book_slots
    ]
    ...
    frame = pd.DataFrame(
        {
            ...
            "Portfolio": [
                _fake(
                    f"STOCK-BOOK-{value % 1_500 + 1:04d} · TRADER-{value % 320 + 1:03d}"
                )
