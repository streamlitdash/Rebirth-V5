"""Native Dash route and composition boundary for the Stock page."""
...
from pages import page_services
from .callbacks import register_callbacks
from .view import build_stock_page_shell, default_stock_dates
