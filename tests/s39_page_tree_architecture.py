"""Final V4 page-tree ownership with no root-level compatibility package."""
...
def test_pages_have_one_v4_owner_and_no_legacy_tree() -> None:
    assert (V4_PAGES / "not_found_404.py").is_file()
...
def test_app_composition_imports_pages_only_from_v4_tree() -> None:
    for relative in ("app/factory.py", "app/routing.py"):
