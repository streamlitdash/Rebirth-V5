...
def _temp_new_positions(market_date: pd.Timestamp) -> pd.DataFrame:
    ...
    rows = [
        {
            ROW_TYPE: MARKET,
            TRADE_ID: "TEMP - CREDIT-001",
            POSITION_ID: "TEMP - CREDIT-POSITION-001",
            RISK_TYPE: "Credit",
            RISK_GREEK: "Delta",
            UNDERLYING: "TEMP_REPLACE_ME - CDX IG",
            TENOR_SWAP: "TEMP_REPLACE_ME - 5Y",
            TENOR_OPTION: "",
        ...
        {
            ROW_TYPE: MARKET,
            TRADE_ID: "TEMP - CREDIT-002",
            POSITION_ID: "TEMP - CREDIT-POSITION-002",
            RISK_TYPE: "Credit",
            RISK_GREEK: "Delta",
            UNDERLYING: "TEMP_REPLACE_ME - iTraxx Main",
            TENOR_SWAP: "TEMP_REPLACE_ME - 7Y",
            TENOR_OPTION: "",
            PORTFOLIO: "TEMP_REPLACE_ME - BOOK_C",
            RISK: -12_500.0,
        ...
        {
            ROW_TYPE: CASHFLOW,
            TRADE_ID: "TEMP - CASHFLOW-001",
            POSITION_ID: "TEMP - CASHFLOW-POSITION-001",
