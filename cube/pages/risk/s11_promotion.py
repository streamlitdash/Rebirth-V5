"""Explicit, revision-bound promotion generations for the V5 Risk page."""
...
class PromotionBasis:
    ...
    def build(
        ...
        *,
        ...
        if not isinstance(reduced_tenor, bool):
            raise ValueError("Promotion reduced-tenor mode must be boolean")
        return cls(
    ...
    def from_dict(cls, value: object) -> PromotionBasis:
        ...
        return cls.build(
            ...
            reduced_tenor=value["reduced_tenor"],
        )
    ...
    def to_dict(self) -> dict[str, object]:
        return {
            ...
            "reduced_tenor": self.reduced_tenor,
        }
...
def promotion_basis_summary(basis: PromotionBasis) -> str:
    ...
    if basis.reduced_tenor:
        parts.append("reduced tenor")
