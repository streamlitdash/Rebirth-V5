"""Small, page-owned components for the V5 Stock workflow."""
...
from cube.adapters.s08_stock import StockConnectorAdapter, StockSource
from cube.domain.s01_schema import PORTFOLIO_MAPPED_COLUMN
from cube.domain.s09_stock import map_stock_comparison_portfolios
...
def build_stock_page_from_data(
    ...
    *,
    ...
    """Build the pure V5 page from one mapped server snapshot."""
